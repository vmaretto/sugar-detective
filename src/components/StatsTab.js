// StatsTab component - Improved version with better layout and accessibility
...
const StatsTab = ({ stats, participants, language }) => {
  ...
  // Calculate additional statistics for questionnaire responses
  const calculateQuestionnaireStats = () => {
    ...
    participants.forEach(p => {
      ...
      if (awareness.useful_spectrometer !== undefined) {
        if (awareness.useful_spectrometer === 'yes') questionnaireStats.spectrometerUseful.yes++;
        else if (awareness.useful_spectrometer === 'no') questionnaireStats.spectrometerUseful.no++;
        else questionnaireStats.spectrometerUseful.maybe++;
      }
      
      // Confidence levels
      if (awareness.confidence !== undefined) {
      ...
      // Knowledge levels
      if (awareness.knowledge !== undefined) {
        const know = parseInt(awareness.knowledge);
      ...
      // Awareness change
      if (awareness.awareness_change !== undefined) {
        const change = parseInt(awareness.awareness_change);
